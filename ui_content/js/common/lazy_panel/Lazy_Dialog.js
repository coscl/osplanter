			...
			_createHeader : function() {
				...
				if(this.options.title_icon){
					$(this.el).find('.cs2c_dialog_header .cs2c_dialog_header_icon')
						.css("background-image","url(/static/images/icons/"+this.options.title_icon+".png)");
				}else{
					$(this.el).find('.cs2c_dialog_header .cs2c_dialog_header_icon')
					.css("background-image","url(/static/images/icons/icon_edit.png)");
				}
